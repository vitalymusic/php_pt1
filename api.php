<?php
 $users = [
    ...
    ['id' => 4,  'username' => 'user03',  'email' => 'user03@example.com',  'role' => 'editor',        'active' => true],
    ['id' => 5,  'username' => 'user04',  'email' => 'user04@example.com',  'role' => 'user',          'active' => false],
    ['id' => 6,  'username' => 'user05',  'email' => 'user05@example.com',  'role' => 'user',          'active' => true],
    ['id' => 7,  'username' => 'user06',  'email' => 'user06@example.com',  'role' => 'moderator',     'active' => true],
    ...
    ['id' => 14, 'username' => 'user13',  'email' => 'user13@example.com',  'role' => 'user',          'active' => true],
    ['id' => 15, 'username' => 'user14',  'email' => 'user14@example.com',  'role' => 'user',          'active' => true],
    ['id' => 16, 'username' => 'user15',  'email' => 'user15@example.com',  'role' => 'editor',        'active' => true],
